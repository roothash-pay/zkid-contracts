...
🧱 系统分层职责
层级	模块	职责
Oracle 层	Oracle Service	负责签发属性承诺与签名
证明层	Prover	生成零知识证明，链下执行
链上层	PolicyRouter.sol, OracleRegistry, Groth16Verifier	统一策略验证入口，完成链上验签与验 ZK
🔒 信任模型一览
          ┌────────────────────────────┐
          │        zkID System         │
          └────────────────────────────┘
